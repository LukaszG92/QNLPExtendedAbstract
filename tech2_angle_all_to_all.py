"""
Tech2: Angle Encoding + All-to-All Entanglement
"""
import argparse
from common import (
    ExperimentConfig,
...
def main():
    parser = argparse.ArgumentParser(description="Tech2: Angle + All-to-All Entanglement")
    ...
    print(f"\n{'#' * 60}")
    print(f"# Tech2: Angle + All-to-All Entanglement")
    ...
    result = evaluate_technique(
        technique_name=f"Tech2_Angle_AllToAll_q{args.q}_L{args.L}",
        qnode=qnode,
        ...
        cfg=cfg,
        extra_params={
            "entanglement_pattern": f"all_to_all_{args.entangler}",
            "encoding": "angle",
            "axis": args.axis,
        },
    )
